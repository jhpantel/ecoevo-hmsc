...
```
We can see that the Environment has an overall negative impact for both species as $E$ drifts randomly towards more positive values (where Species 2 is closer because it has a higher trait value). We also see that the residual species association effects are strongly positive. We evaluate this by greatly increasing the effects if interspecific competition (while decreasing the strength of environmental variation).
