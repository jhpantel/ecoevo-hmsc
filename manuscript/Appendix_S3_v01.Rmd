...
```
```{r figs2, fig.pos = "H",echo=FALSE, fig.show="hold", fig.cap = "\\label{fig:figs2} Simulated (dark blue points) population size over time for $h^2 = 0$, with posterior predicted mean (light blue points) and 95% highest density intervals (light blue bars)."}
# prepare for plot
